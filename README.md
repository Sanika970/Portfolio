...
- Optimized performance for peak traffic
- Ensured secure and scalable backend communication between services

---

## 🧠 ChatGPT From Scratch
Built a transformer-based language model inspired by ChatGPT.
...
## 🧑‍💻 CA Portal – Techfest IIT Bombay
Portal for **17,000+ campus ambassadors**.

- Built dashboards and dynamic forms
- Automated workflows for **20+ tasks**

---

## ⚡⚡⚡ Harry Potter Animated Website
React website with animations and dynamic components (Magical Harry Potter themed)
...
Interactive journaling platform with activity modules.
...
## 💱 Currency Converter
Web app supporting **150+ currencies**.
